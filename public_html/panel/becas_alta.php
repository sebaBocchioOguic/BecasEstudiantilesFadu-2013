          ...
          <tr valign="top"> 
            ...
            <td> 
              <table width="102" border="0" cellspacing="0" cellpadding="0" id="solicitud_beca_table">
                ...
                <tr><td colspan="2">ACABAS DE DAR DE ALTA EXITOSAMENTE LA SIGUIENTE BECA</td></tr>
                <tr><td colspan="2">&nbsp;</td></tr>
	<?php
	/* Realiza la conexión a la tabla de becas */
	include("../conexion/conexion.php");

	$add_becas="insert into becas (`nombre_becas` ,`total_vacantes_becas` ,`vigente_becas`)	values ('$nombre_beca', '$total_vacantes_beca', '$vigente_beca');";
	mysql_query($add_becas);
	?>
                <tr>
                    <th style="text-align:left;">N&uacute;mero de Beca</th>
                    <td style="font-weight: bold;"><?php echo(mysql_insert_id());?></td>
			    </tr>
                <tr>
                ...
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr>
                    <th colspan="2" class="titulo_panel"><a href="panel_control_becas_alta.php" target="_self">Regresar al Alta de Becas</a></th>
			    </tr>
                <tr>
