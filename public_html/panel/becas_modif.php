...
$id_beca		= $_POST['seleccion_beca'];
$nombre_beca 	= $_POST['nombre_beca'];
$total_vacantes_beca 	= $_POST['vacantes_beca'];
//$vigente_beca	= $_POST['vigente_beca'];

if ($_POST['vigente_beca'] == true)
	$vigente_beca = "S";
else
	$vigente_beca = "N";
?>
          ...
          <tr valign="top"> 
            ...
            <td> 
              <table width="102" border="0" cellspacing="0" cellpadding="0" id="solicitud_beca_table">
                ...
                <tr>
                	<td colspan="2" class="titulo_form">Panel de control - Becas - Alta de Becas</td>
                </tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr><td colspan="2">ACABAS DE MODIFICAR EXITOSAMENTE LA SIGUIENTE BECA</td></tr>
                <tr><td colspan="2">&nbsp;</td></tr>
	<?php
	/* Realiza la conexión a la tabla de becas */
	include("../conexion/conexion.php");

	$upd_becas="update becas set nombre_becas='$nombre_beca', total_vacantes_becas='$total_vacantes_beca', vigente_becas='$vigente_beca' where id_beca='$id_beca' LIMIT 1;";
	mysql_query($upd_becas);
	?>
                <tr>
                    <th style="text-align:left;">N&uacute;mero de Beca</th>
                    <td style="font-weight: bold;"><?php echo($id_beca);?></td>
			    </tr>
                <tr>
                    <th style="text-align:left;">Nombre de Beca</th>
                    <td style="font-weight: bold;"><?php echo($nombre_beca);?></td>
			    </tr>
                <tr>
                    <th style="text-align:left;">Total de Vacantes</th>
                    <td><?php echo($total_vacantes_beca);?></td>
			    </tr>
                <tr>
                    <th style="text-align:left;">Vigente</th>
                    <td><?php 
														if ($vigente_beca == "S") echo("S&iacute;");
														else echo("No");	?></td>
			    </tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr>
                    <th colspan="2" class="titulo_panel"><a href="panel_control_becas_modif.php" target="_self">Regresar a Modificar Becas</a></th>
			    </tr>
                <tr>
                    <th colspan="2" class="titulo_panel"><a href="panel_control_becas.php" target="_self">Regresar al Panel de Becas</a></th>
			    </tr>
                <tr>
                    <th colspan="2" class="titulo_panel"><a href="panel_control.php" target="_self">Regresar al Panel Principal</a></th>
			    </tr>
              </table>
            </td>
            <td class="texto">&nbsp;</td>
