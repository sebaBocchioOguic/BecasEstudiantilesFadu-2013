          ...
          <tr valign="top"> 
            ...
            <td> 
              <table width="102" border="0" cellspacing="0" cellpadding="0" id="solicitud_beca_table">
                ...
                <tr>
                	<td colspan="2" class="titulo_form">Panel de control - Becas</td>
                </tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr>
                    <th colspan="2" class="titulo_panel"><a href="panel_control_becas_consulta.php" target="_self">Consulta de Becas</a></th>
			    </tr>
                <tr>
                    <th colspan="2" class="titulo_panel"><a href="panel_control_becas_alta.php" target="_self">Alta de Becas</a></th>
			    </tr>
                <tr>
                    <th colspan="2" class="titulo_panel"><a href="panel_control_becas_modif.php" target="_self">Modificaci&oacute;n de Becas</a></th>
			    </tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr>
