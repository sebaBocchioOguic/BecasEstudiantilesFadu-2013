...
<html>
	<head>
		...
		function validar_campos(){
			if(trim(document.getElementById("nombre_beca").value).length == 0){ // Valido que el nombre de la beca no viaje vacío
                alert('Debe ingresar el nombre de la beca'); return 0;}

			if(trim(document.getElementById("vacantes_beca").value).length == 0){ // Valido que la cantidad de vacantes no viaje vacía
          ...
          <tr valign="top"> 
            ...
            <td> 
              <table width="102" border="0" cellspacing="0" cellpadding="0" id="solicitud_beca_table">
                ...
                <tr>
                	<td colspan="4" class="titulo_form">Panel de control - Becas - Alta de Becas</td>
                </tr>
                <tr><td colspan="4">&nbsp;</td></tr>
				<form id="alta_beca_form" name="alta_beca_form" action="becas_alta.php" method="post">
                <tr>
                    <th>Nombre Beca</th>
                ...
                <tr>
                    <td colspan="4" style="text-align:center;"><input name="envio_alta_beca" type="button" id="envio_alta_beca" value="Alta de Beca" onClick="javascript:validar_campos();" style="margin:15px;" /></td>
			    </tr>
				</form>
                <tr><td colspan="4">&nbsp;</td></tr>
                <tr><td colspan="4">&nbsp;</td></tr>
