          ...
          <tr valign="top"> 
            ...
            <td> 
              <table width="102" border="0" cellspacing="0" cellpadding="0" id="solicitud_beca_table">
                ...
                <tr>
                	<td colspan="4" class="titulo_form">Panel de control - Becas - Consulta de Becas</td>
                </tr>
                <tr><td colspan="4">&nbsp;</td></tr>
	<?php
	/* Realiza la consulta de becas */
	include("../conexion/conexion.php");?>
				<tr><th style="width:45px;">Id</th>
                    <th style="width:229px;">Nombre Beca</th>
                    <th style="width:85px;">Vacantes</th>
                    <th style="width:*;">Vigente</th>
                </tr>
	<?php 
	$total_becas_vigentes = 0;
	$consulta="select * from becas order by 1";
	$resultado=mysql_query($consulta);
	while($fila=mysql_fetch_array($resultado)){?>
				<tr><td><?php echo($fila[id_beca]);?></td>
                	<td><?php echo($fila[nombre_becas]);?></td>
                    <td><?php echo($fila[total_vacantes_becas]);?></td>
                    <td><?php echo($fila[vigente_becas]);?></td>
                </tr>
<?php	if ($fila[vigente_becas] == "S") $total_becas_vigentes++;
		} //end while
				?>
                <tr><td colspan="4">&nbsp;</td></tr>
				<tr><td colspan="4">Total de becas vigentes: <?php echo($total_becas_vigentes);?></td></tr>
                <tr><td colspan="4">&nbsp;</td></tr>
                <tr><td colspan="4">&nbsp;</td></tr>
                <tr>
