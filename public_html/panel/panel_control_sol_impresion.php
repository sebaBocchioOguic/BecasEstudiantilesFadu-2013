          ...
          <tr valign="top"> 
            ...
            <td> 
              <table width="102" border="0" cellspacing="0" cellpadding="0" id="solicitud_beca_table">
                ...
                <tr>
                	<td colspan="4" class="titulo_form">Panel de control - Solicitudes - Impresi&oacute;n</td>
                </tr>
                <tr><td colspan="4">&nbsp;</td></tr>
				<form id="consulta_solicitudes_form" name="consulta_solicitudes_form" action="solicitudes_impresion.php" method="post">
                <tr>
               ...
               <td colspan="4" style="text-align:center;"><input type="button" value="Imprimir Credenciales" name="enviar_solicitud" id="enviar_solicitud" onClick="javascript:validar_campos();"  style="margin:15px;" /></td>
				</form>
                <tr><td colspan="4">&nbsp;</td></tr>
                <tr>
