          ...
          <tr valign="top"> 
            ...
            <td> 
              <table width="102" border="0" cellspacing="0" cellpadding="0" id="solicitud_beca_table">
                ...
                <tr>
                	<td colspan="2" class="titulo_form">Panel de control - Solicitudes</td>
                </tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr>
                    <th colspan="2" class="titulo_panel"><a href="panel_control_sol_consulta.php" target="_self">Consulta de Solicitudes</a></th>
			    </tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr>
                    <th colspan="2" class="titulo_panel"><a href="panel_control_sol_impresion.php" target="_self">Impresi&oacute;n de Credenciales</a></th>
			    </tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr>
